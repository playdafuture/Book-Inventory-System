...
public class UI_MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Update Catalog");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //User management button pressed
        int userLevel = Client.checkUserLevel();
        if (userLevel == 0) {
            //admin level
            if (Client.searchUser == null) {
                Client.initUI_SearchUser();
            } else {
                Client.showUI_SearchUser();
            }
        } else {
            Client.initUI_popMessage("You do you have the priviledge to perform this task");
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Search inventory button pressed
        if (Client.searchInventory == null) {
            Client.initUI_SearchInventory();
        } else {
            Client.showUI_SearchInventory();
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        //Catalog management pressed
        int userLevel = Client.checkUserLevel();
        if (userLevel == 0) {
            //admin level
            Client.initUI_UpdateCatalog(null);
        } else {
            Client.initUI_popMessage("You do you have the priviledge to perform this task");
        }        
